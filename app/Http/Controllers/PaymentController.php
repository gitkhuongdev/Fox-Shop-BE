...
class PaymentController extends Controller
{
    ...
    public function vnpayreturn(Request $request){
        ...
        $payment_management->money = $data['vnp_Amount'];
        $payment_management->note = $data['vnp_OrderInfo'];
        $payment_management->response_code = $data['vnp_ResponseCode'];
        $payment_management->code_vnpay = $data['vnp_TransactionNo'];
