                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div className="d-flex">
                                                            <div>
                                                                <img style={{width: '80px'}} src="https://file.hstatic.net/200000503583/file/phong-cach-thoi-trang-nam-13_d022183aeab04052bd4054396f3de231.jpg" alt="" />
                                                            </div>
                                                            <div>
                                                                <span>Tên:</span>
                                                                <span className="ms-3">Áo polo nam thuươợng hiệu dđiỉnh cao fsdaf</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td></td>
