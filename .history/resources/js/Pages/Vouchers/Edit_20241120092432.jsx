                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="form-group">
                                ...
                                <input value={code} onChange={(e) =>setCode(e.target.value)} type="text" name="code" className="form-control"/>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="form-group mt-3">
                                    ...
                                    <input value={value} onChange={(e) =>setValue(e.target.value)} type="number" name="value" className="form-control"/>
                                </div>
                                <div className="form-group mt-3">
                                    <label htmlFor="">Mệnh giá áp dung</label>
                                    <input value={monney} onChange={(e) =>setMonney(e.target.value)} type="number" name="monney" className="form-control"/>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label htmlFor="">Giới hạn Voucher</label>
                                    <input value={limit} onChange={(e) =>setLimit(e.target.value)} type="number" name="limit" className="form-control"/>
                                </div>
                                <div className="form-group mt-3">
                                    <label htmlFor="">Ngày bắt đầu</label>
<input value={start} onChange={(e) =>setStart(e.target.value)} type="date" name="start" className="form-control"/>
                                </div>
                                <div className="form-group mt-3">
                                    <label htmlFor="">Ngày kết thúc</label>
                                    <input value={end} onChange={(e) =>setEnd(e.target.value)} type="date" name="end" className="form-control"/>
                                </div>
                            </div>
                        </div>
                    </div>
