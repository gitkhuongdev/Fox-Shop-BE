                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="form-group">
                                    ...
                                    <input onChange ={(e) =>setCode(e.target.value)} name="code" className="form-control" type="text" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group mt-3">
                                        ...
                                        <select  onChange ={(e) =>setType(e.target.value)} name="type" id="" value={type}>
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        <input onChange ={(e) =>setValue(e.target.value)} name="value" className="form-control" type="number" />
                                    </div>
                                    <div className="form-group mt-3">
                                        <label htmlFor="">Mệnh giá áp dụng Voucher</label>
                                        <input onChange ={(e) =>setMonney(e.target.value)} name="monney" className="form-control" type="number" />
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group mt-3">
                                        <label htmlFor="">Giới hạn Voucher</label>
                                        <input onChange ={(e) =>setLimit(e.target.value)} name="limit" className="form-control" type="number" />
                                    </div>
                                    <div className="form-group mt-3">
<label htmlFor="">Ngày bắt đầu</label>
                                        <input onChange ={(e) =>setStart(e.target.value)} name="start" className="form-control" type="date" />
                                    </div>
                                    <div className="form-group mt-3">
                                        <label htmlFor="">Ngày kết thúc</label>
                                        <input onChange ={(e) =>setEnd(e.target.value)} name="end" className="form-control" type="date" />
                                    </div>
                                </div>
                            </div>
