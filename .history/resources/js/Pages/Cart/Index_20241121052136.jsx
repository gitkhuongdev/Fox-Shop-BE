...
function Index({ data }) {
    ...
    const [showBtn , setShowBtn] = useState(voucher)
    ...
    const cancelVoucher = () => {
        setTotalAmount(cart.reduce((total, item) => total + item.product.price * item.quantity, 0));
                                ...
                                {voucher.length === 0 ? (
                                    ...
                                    voucher.map((item) => (
                                        ...
                                        >
                                            ...
                                            {appliedVoucher && appliedVoucher.id === item.id ? (
