...
<body style="font-family: Arial, sans-serif; background-color: #f4f7fa;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border-radius: 8px; text-align: center;">
        ...
        <p style="font-size: 16px; color: #333;">Bạn đã nhận được mã voucher:</p>
        <h2 style="font-size: 28px; color: #4CAF50; margin: 20px 0;">{{ $voucherCode }}</h2>
        <p style="font-size: 16px; color: #333;">Giảm giá {{ $discount }} cho đơn hàng tiếp theo của bạn!</p>
