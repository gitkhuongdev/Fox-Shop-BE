...
class DashboardController extends Controller
{
    ...
    public function searchDate(Request $request)
    {
        ...
        $startDate = $request->start_date; // Chuỗi ngày từ request
        $endDate = $request->end_date; // Chuỗi ngày từ request

        // Kiểm tra xem ngày có hợp lệ không (có thể sử dụng Carbon để kiểm tra)
